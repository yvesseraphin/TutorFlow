...
# Configure structured terminal logging so all live classroom and tutor logs show up in uvicorn stdout
logging.basicConfig(
    level=logging.INFO,
...
logging.getLogger("tutorflow").setLevel(logging.INFO)

from fastapi import FastAPI
from fastapi.middleware.cors import CORSMiddleware

from backend.config import settings
from backend.routers import analytics, auth_supabase, classes, curriculum, diagnostics, flashcards, live_tutor, profile, tutor
